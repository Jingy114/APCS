...
- You can make _size = _data.length and use _size in subsitution for every _data.length in the code.
QCC
- Is it possible to assign an array to a new array without using a loop to set each index individually?
- Is it possible to reduce the size of an array without making a new one and copying the contents in?
- 
*/
